    ...
    public function midtrans()
{
    ...
    // Iterasi semua barang untuk menghitung total harga
    ...
    $transactionDetails = [
        'order_id' => uniqid(), // Gunakan ID pesanan yang unik
        'gross_amount' => $total_harga, // Gunakan total harga dari semua barang yang dibeli
    ];
